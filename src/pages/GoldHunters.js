...
<span className='text-[16px]'>
      ...
      <h1 className='flex w-full justify-center items-center space-x-1 pb-2'>
        <img src={images.logo}className='w-[30px]' alt='engagecoin'/>
         <span className='text-[#fff] text-[32px] font-bold'>
           <span className='pl-[2px]'>{formatNumber(balance + refBonus)} <span className='text-btn4'>{texts.projectSymbol}</span></span>
        </span>
      </h1>
      <div>
  ...
  <div class="after"></div>
      ...
      {energy === 0 && points === 0 ? (
          ...
          <span className='text-[#fff] font-semibold text-[24px]'>
            <span className='pl-[2px]'>{points} <span className='text-btn4'>{texts.projectSymbol}</span></span>
          </span>
          <button 
            onClick={handleClaim} 
            disabled={points === 0} 

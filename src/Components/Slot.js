      ...
      <div className='w-full flex justify-between items-center pb-2 px-4'>
        ...
        <div className='flex items-center'>
          <span className='flex items-center mt-[-1px]'>
            <img src={images.logo} className='w-[16px] rounded-full' alt='engagecoin'/>
          </span>
          <span className='text-[#fff] font-semibold text-[16px]'>
            <span className='pl-[4px]'>{formatNumber(points)} <span className='text-secondary'>{texts.projectSymbol} </span></span>
          </span>
        </div>
